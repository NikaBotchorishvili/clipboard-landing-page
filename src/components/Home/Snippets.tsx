	...
	return (
		<section className="flex flex-col w-[100dvw] gap-20">
			<article className="max-w-xl text-center mt-5 md:mx-auto mx-5">
				<h1 className="text-2xl">Keep track of your snippets</h1>
			...
			<article className="relative flex flex-col lg:block items-center mx-5 md:mx-0 ">
				<img
				...
				<div className="flex lg:w-[85%]   justify-end md:mt-5 ">
					<ul className="max-w-sm flex flex-col gap-y-4">
						<li className="flex flex-col gap-y-1">
							<h1 className="text-xl">Quick Search</h1>
						...
						<li className="flex flex-col gap-y-1">
							<h1 className="text-xl">iCloud Sync</h1>
							<p className="text-md text-grayishBlue">
						...
						<li className="flex flex-col gap-y-1">
							<h1 className="text-xl">Complete History</h1>
							<p className="text-md text-grayishBlue">
